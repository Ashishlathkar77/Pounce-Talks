...
function BriefCard({ sessionId }: { sessionId: string }) {
  ...
  if (error || !data) {
    return (
      <Surface variant="secondary" radius="lg" padding="lg" border="none">
        <div style={{ display: "flex", alignItems: "center", gap: "var(--space-xs)" }}>
          <i className="ph ph-warning" style={{ fontSize: 18, color: "var(--text-neutral-disabled)" }} />
          <div>
            <Typography variant="body-sm-semibold" color="primary">Brief unavailable</Typography>
            <Typography variant="caption-regular" color="tertiary">Could not load pre-call intelligence for this run.</Typography>
          </div>
        </div>
      </Surface>
    );
  ...
  return (
    <Stack gap="lg">
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "var(--space-sm)" }}>
        {data.logo_url ? (
          <div style={{
            ...
            <img src={data.logo_url} alt="Company logo" style={{ width: 40, height: 40, objectFit: "contain" }} />
          </div>
        ) : (
          <div style={{
            width: 48, height: 48, borderRadius: 10,
            ...
            <i className="ph ph-buildings" style={{ fontSize: 22, color: "var(--text-neutral-tertiary)" }} />
          </div>
        )}
        <div>
          <Typography variant="body-md-semibold" color="primary">Pre-call Intelligence</Typography>
          <Typography variant="caption-regular" color="tertiary">Generated by GPT-4.1-mini before dial</Typography>
        </div>
        <div style={{ marginLeft: "auto" }}>
          <Tag size="sm" variant="info">AI Brief</Tag>
        </div>
      </div>
      ...
      <Surface variant="secondary" radius="lg" padding="md" border="none">
        <Stack gap="xs">
          <div style={{ display: "flex", alignItems: "center", gap: "var(--space-xs1)" }}>
            ...
            <Typography variant="overline-semibold" color="tertiary">Company</Typography>
          </div>
          <Typography variant="body-sm-regular" color="primary" style={{ lineHeight: 1.6 }}>
      ...
      <Surface
        ...
        padding="md"
        border="none"
        style={{ borderLeft: "3px solid var(--red-400)" }}
      >
        <Stack gap="xs">
          <div style={{ display: "flex", alignItems: "center", gap: "var(--space-xs1)" }}>
            <i className="ph ph-warning-circle" style={{ fontSize: 13, color: "var(--red-500)" }} />
            <Typography variant="overline-semibold" style={{ color: "var(--red-600)" }}>Likely Pain</Typography>
          </div>
          <Typography variant="body-sm-regular" color="primary" style={{ lineHeight: 1.6 }}>
            {data.likely_pain}
          </Typography>
      ...
      <Surface
        ...
        padding="md"
        border="none"
        style={{ borderLeft: "3px solid var(--brand-400)" }}
      >
        <Stack gap="xs">
          <div style={{ display: "flex", alignItems: "center", gap: "var(--space-xs1)" }}>
            <i className="ph ph-lightning" style={{ fontSize: 13, color: "var(--brand-500)" }} />
            <Typography variant="overline-semibold" style={{ color: "var(--brand-600)" }}>Opener Angle</Typography>
          </div>
          <Typography variant="body-sm-medium" color="primary" style={{ lineHeight: 1.6, fontStyle: "italic" }}>
            &ldquo;{data.opener_angle}&rdquo;
          </Typography>
        </Stack>
      </Surface>
      ...
      <Stack gap="sm">
        <div style={{ display: "flex", alignItems: "center", gap: "var(--space-xs1)" }}>
          <i className="ph ph-chat-dots" style={{ fontSize: 13, color: "var(--text-neutral-tertiary)" }} />
          <Typography variant="overline-semibold" color="tertiary">Talking Points</Typography>
        </div>
        <Stack gap="xs">
          {data.talking_points.map((point, i) => (
            <div key={i} style={{ display: "flex", gap: "var(--space-xs)", alignItems: "flex-start" }}>
              ...
              <Typography variant="body-sm-regular" color="primary" style={{ lineHeight: 1.55 }}>
                {point}
              </Typography>
            </div>
          ))}
