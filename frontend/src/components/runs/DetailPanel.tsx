...
function BriefCard({ sessionId }: { sessionId: string }) {
  const { data, isLoading, error } = useSWR<BriefData>(
    `/api/runs/${sessionId}/brief`,
    fetcher,
  ...
  if (error || !data) {
    return (
      <div style={{
        ...
        <i className="ph ph-warning" style={{ fontSize: 16, color: "var(--text-neutral-disabled)", flexShrink: 0 }} />
        <div>
          <div style={{ fontSize: 13, fontWeight: 600, color: "var(--text-neutral-primary)" }}>Brief unavailable</div>
          <div style={{ fontSize: 12, color: "var(--text-neutral-tertiary)", marginTop: 2 }}>Intelligence could not be generated for this run.</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
        <div style={{
          ...
          {data.logo_url
            ...
            ? <img src={data.logo_url} alt="" style={{ width: 22, height: 22, objectFit: "contain" }} />
            : <i className="ph ph-buildings" style={{ fontSize: 13, color: "var(--text-neutral-tertiary)" }} />}
        </div>
        <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.07em", textTransform: "uppercase", color: "var(--text-neutral-tertiary)" }}>
          Pre-call intelligence
        </span>
        <span style={{ marginLeft: "auto", fontSize: 10, color: "var(--text-neutral-disabled)" }}>GPT-4.1-mini</span>
      </div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--text-neutral-tertiary)", marginBottom: 5 }}>Company</div>
        <div style={{ fontSize: 13, color: "var(--text-neutral-primary)", lineHeight: 1.6 }}>{data.company_summary}</div>
      </div>

      {/* Pain + Opener side-by-side */}
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
        <div style={{
          padding: "11px 14px", borderRadius: 10,
          background: "var(--bg-neutral-secondary)",
          borderTop: "2px solid var(--red-400)",
          border: "1px solid var(--border-neutral-subtle)",
          borderTopColor: "var(--red-400)",
        }}>
          <div style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--red-500)", marginBottom: 5 }}>Pain</div>
          <div style={{ fontSize: 12.5, color: "var(--text-neutral-primary)", lineHeight: 1.55 }}>{data.likely_pain}</div>
        </div>
        <div style={{
          padding: "11px 14px", borderRadius: 10,
          background: "var(--bg-neutral-secondary)",
          ...
          <div style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--brand-600)", marginBottom: 5 }}>Opener</div>
          <div style={{ fontSize: 12.5, color: "var(--text-neutral-primary)", lineHeight: 1.55, fontStyle: "italic" }}>&ldquo;{data.opener_angle}&rdquo;</div>
        </div>
      </div>

      {/* Talking points */}
      <div style={{ marginTop: 2 }}>
        <div style={{ fontSize: 10.5, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--text-neutral-tertiary)", marginBottom: 6 }}>Talking points</div>
        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          {data.talking_points.map((pt, i) => (
            <div key={i} style={{ display: "flex", alignItems: "baseline", gap: 9 }}>
              ...
              <span style={{ fontSize: 13, color: "var(--text-neutral-primary)", lineHeight: 1.55 }}>{pt}</span>
            </div>
          ))}
        </div>
      </div>
...
export function RunDetailPanel({
  ...
  const [activeTab, setActiveTab] = useState<"brief" | "details" | "analytics" | "graph">("brief");
